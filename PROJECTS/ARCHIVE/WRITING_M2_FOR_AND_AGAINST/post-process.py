#!/usr/bin/env python3
"""Post-process the M2 For and Against — Lesson 3 deck.
...
SLIDE_DIR = "PROJECTS/WRITING_M2_FOR_AND_AGAINST/slides"
...
h = h.replace(
    'data-id="slide-task-intro-1"',
    'data-id="slide-task-intro-1" data-timer="300" data-timer-autostart="true"',
)
h = h.replace(
