...
Reads the 6 essay topics verbatim from ESSAY_TOPICS.JSON. Each card shows:
- Numbered header with accent colour and a speech-bubble icon
- The topic context sentences (advantages and disadvantages)
- The question ("Are you for or against using this kind of technology?") in a highlighted box
- A For - Against - Opinion footer strip

Output: PDF/essay-topic-cards-M2.pdf (gh-pages-safe, Ghostscript-flattened).
"""
...
PDF_PATH = PDF_DIR / "essay-topic-cards-M2.pdf"

FINAL_QUESTION = "Are you for or against using this kind of technology?"
...
CARD_HTML = r"""<div class="card">
  ...
  <div class="card-footer">
    <span class="fa-hint">For <span class="sep" style="color:{accent}">&mdash;</span> Against <span class="sep" style="color:{accent}">&mdash;</span> Opinion</span>
