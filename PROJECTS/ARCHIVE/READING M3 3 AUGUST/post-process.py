#!/usr/bin/env python3
"""Post-processing for READING M3 3 AUGUST deck.
...
Timer: discussion-task (8 min, autostart).
"""
from pathlib import Path

path = Path("PROJECTS/READING M3 3 AUGUST/slides/index.html")
h = path.read_text(encoding="utf-8")

# ── Discussion task: 8-minute timer, auto-start (idempotent) ──
if 'data-timer="480"' not in h:
    h = h.replace(
        'data-id="slide-discussion-task-1"',
        'data-id="slide-discussion-task-1" data-timer="480" data-timer-autostart="true"',
    )
