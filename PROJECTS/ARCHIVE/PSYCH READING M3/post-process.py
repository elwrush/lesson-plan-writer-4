#!/usr/bin/env python3
"""Post-processing for PSYCH READING M3 deck.
...
Timers: entry-ticket (4 min, autostart), self-check (60 s, autostart).
"""
from pathlib import Path

path = Path("PROJECTS/PSYCH READING M3/slides/index.html")
