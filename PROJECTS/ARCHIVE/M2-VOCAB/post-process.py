#!/usr/bin/env python3
"""Post-process the M2-VOCAB deck.
...
SLIDE_DIR = "PROJECTS/M2-VOCAB/slides"
...
# Timed slides (auto-start) — guards prevent duplicates on re-run
timers = {
    "entry-ticket-task": "300",
    "ex1-task": "360",
    "ex2-task": "180",
    "ex3-task": "300",
    "ex4-task": "240",
    "freer-discussion": "300",
}
