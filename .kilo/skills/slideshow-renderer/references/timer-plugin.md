...
```css
.timer-pill{display:none;position:absolute;bottom:24px;left:50%;transform:translateX(-50%);z-index:100;background:rgba(0,0,0,0.75);border-radius:28px;padding:8px 18px;box-shadow:0 4px 20px rgba(0,0,0,0.5);align-items:center;gap:12px;font-family:"Courier New",Courier,monospace;user-select:none}
