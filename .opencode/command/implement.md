---
description: Execute tasks from .spec/{name}/tasks.md. Follows red-green TDD: write tests first, confirm FAIL, implement, confirm PASS.
---
# Command: implement

## Usage
`/implement {feature-name}` — `$ARGUMENTS` is the feature name.
