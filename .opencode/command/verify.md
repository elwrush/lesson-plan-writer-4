---
description: Read-only completeness check. Compares proposal + tasks against actual code. Reports drift, missing coverage, unmet done criteria. Does NOT edit files.
---
# Command: verify

## Usage
`/verify {feature-name}` — `$ARGUMENTS` is the feature name.
