---
description: Entry point for the lightweight spec kit. Reads project state and routes to the right workflow command (/explore, /propose, /implement, /verify).
---
# Command: project-go

## Usage
`/project-go [description of what you want to do]` — `$ARGUMENTS` is the optional description.
